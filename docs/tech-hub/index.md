...
- **[Router Nodes — Technical Reference](router-tech.md)** — Technical configuration details for LLM and Static Router nodes: route tagging, keyword behaviour, history mode, and nested key syntax for the Static Router.
