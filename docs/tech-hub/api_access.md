...
Using the API allows you to interact with your chatbot programmatically. This comes in especially useful when you're using a third-party system to evaluate your chatbot. API access is enabled by default for all bots.
