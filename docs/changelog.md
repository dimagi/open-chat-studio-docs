...
* **BUG** Fixed a JavaScript `ReferenceError` on unauthenticated pages (login, password reset) caused by the shared messages partial referencing htmx where it wasn't loaded.
