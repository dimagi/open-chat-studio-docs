...
# Changelog
## Feb 20, 2026
* **NEW** Added support for Claude Sonnet 4.6 model with adaptive thinking. Claude Sonnet 4.6 is now the default Anthropic model, replacing Claude Opus 4.6 as the default.
