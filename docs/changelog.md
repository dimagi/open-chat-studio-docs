...
* **NEW** Added more granular conversation end event types. Users can now create events based on who ended the conversation (user, bot, timeout, or inactive user). The generic conversation end trigger remains as a catch-all that fires whenever any conversation ends.
