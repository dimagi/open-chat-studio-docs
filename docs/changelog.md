...
## Sep 22, 2026
* **BUG** Fixed the team dashboard failing to load. Depending on the order the page's scripts finished loading, a JavaScript error could leave the dashboard's filters and panels blank.
