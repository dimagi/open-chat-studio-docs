...
# Changelog
## Feb 27, 2026
* **NEW** Tracing is now available to all users — no feature flag required. View and debug conversation traces directly from the session detail page. [Learn more](concepts/team/tracing.md)
