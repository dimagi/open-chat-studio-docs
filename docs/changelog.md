...
## Jul 27, 2026
* **BUG** Fixed an error that broke the message tag controls on the session messages page when a tag name contained an apostrophe. Such tags now display and work correctly.
