...
## Aug 4, 2026
* **CHANGE** The daily spend chart in the Cost Tracking panel now shows chat spend and evaluation spend as two stacked series, so you can see how much of your team's LLM bill comes from evaluations. The panel's headline total is unchanged — it always included evaluations. Filtering by chatbot, participant, or platform still shows chat spend only, since evaluation spend is never attributed to an individual chatbot or participant.
