...
This tutorial walks you through finding, reading, and configuring [notifications](../concepts/notifications.md) —
the alerts Open Chat Studio sends when something needs your attention across your chatbots.
...
3. To end it early, use the cancel option on the same widget.
