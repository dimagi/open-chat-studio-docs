...
This feature allows you to extend the functionality of your bot by integrating it with other services and provide health status monitoring.
...
When you create a custom action, each API endpoint in the OpenAPI schema will be available as a separate action in the ChatBot configuration. This gives you full control over which actions are available to your bot.
