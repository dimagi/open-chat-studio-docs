...
All three providers support inbound media — users can send images and documents to your WhatsApp number and the bot will receive them. Size and format limits are set by each provider, not by OCS.
