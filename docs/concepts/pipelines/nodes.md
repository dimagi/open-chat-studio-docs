...
| `outputs` | The outputs generated by the previous node. This is a dictionary where they            |
| `attachments` | A list of attachments passed in by the user. See [Attachment](#python_node.Attachment) |
