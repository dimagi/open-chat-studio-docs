...
A pipeline is a way to build a bot by combining one or more steps together. In future, pipelines will be the default
way to build bots in Open Chat Studio.
