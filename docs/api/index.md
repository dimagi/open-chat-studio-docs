...
- **OAuth2 Authentication:** OAuth2 authentication using scopes, either for a signed-in user (authorization code flow) or for machine-to-machine integrations (client-credentials flow). See the [getting started page](getting_started_with_oauth.md) on how to get started.
