---
title: How-to Guides
description: How to accomplish common tasks in Open Chat Studio
---
...
-   :material-clock-fast:{ .lg .middle } __Useful User Guides__
    ...
    [:octicons-arrow-right-24: Choose an LLM model for your Chatbot](./choose_llm_model.md)

    [:octicons-arrow-right-24: Adjust LLM Node model parameters](./adjust_llm_node_model_parameters.md)

    [:octicons-arrow-right-24: Chatbot Workflow Cookbook](./workflow_cookbook.md)  
