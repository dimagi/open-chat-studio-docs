...
### Select the source material for your chatbot
Once you’ve created your source material, it should appear in the list of source materials when editing your chatbot.
...
```text
You are a friendly chatbot. Be sure to reference the source material before answering the user's query:
