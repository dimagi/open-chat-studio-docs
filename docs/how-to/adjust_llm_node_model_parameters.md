...
This guide walks you through adjusting the LLM model parameters on an [LLM node](../concepts/pipelines/nodes.md#llm-node) in your chatbot [pipeline](../concepts/pipelines/index.md). It assumes you already have a chatbot or pipeline open for editing.
